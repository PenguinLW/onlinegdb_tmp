...
def rock_scissors_paper(player_choice):
    ...
    print( "Ничья!" if (((name_to_number(comp_number)-name_to_number(player_choice)) % 5) == 0) else ("Компьютер выиграл!" if (((name_to_number(comp_number)-name_to_number(player_choice)) % 5) == 1) else "Игрок выиграл!" ));
    print("\n");
    ...
    if(ch == 0):
        ...
        rock_scissors_paper(number_to_name(random.randrange(0,5)));
